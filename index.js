...
const start = (geps = new Client()) => {
    ...
    console.log(color(figlet.textSync('RidhoSenpai', 'Larry 3D'), 'cyan'))
    console.log(color(figlet.textSync('------------', 'Larry 3D'), 'green'))
    ...
    console.log(color('[PixelCraftGaming]', 'cyan'), color('RidhoSenpai is online now!', 'green'))
    console.log(color('[DEV]', 'cyan'), color('Welcome back, Semoga harimu baik~', 'green'))
    ...
    geps.onMessage((message) => {
        geps.getAmountOfLoadedMessages()
            .then((msg) => {
                if (msg >= 1000) {
                    console.log(color('[RidhoSenpai]', 'cyan'), color(`Loaded message reach ${msg}, cuting message cache...`, 'green'))
                    //console.log('[MrG3P5]', color(`Loaded message reach ${msg}, cuting message cache...`, 'yellow'))
                    geps.cutMsgCache()
                    console.log(color('[RidhoSenpai]', 'cyan'), color('Success Cache deleted!', 'green'))
    ...
    geps.onGlobalParicipantsChanged(async (event) => {
